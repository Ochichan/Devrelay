...
| M9 Environment hydration | Partial | Trust hashes, bootstrap fingerprint file content hashing, profile selection, Nix, Dev Container, and native bootstrap adapter paths exist. Secrets, hydration state, and doctor remain open. |

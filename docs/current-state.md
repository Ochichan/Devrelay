...
| M9 Environment hydration | Partial | Trust hashes, bootstrap fingerprint file content hashing, profile selection, Nix, Dev Container, native bootstrap adapter, and secret provider materialization paths exist. Hydration state and doctor remain open. |

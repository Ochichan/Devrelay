...
| M13 Security and operations | Partial | Threat model, fuzzing, diagnostics, fault injection, secret scanning pieces, false-positive override design, encrypted one-time sidecar design, and release/update policy exist. Backup anchor, opaque anchor, and independent review remain open. |
